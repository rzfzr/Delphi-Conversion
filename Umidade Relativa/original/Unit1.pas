...
begin
  edt_temp_seco.Text := '0';
  edt_temp_umido.Text := '0';
  edt_pressao.Text := '101,3';
  lbl_res_orv_c.Caption := '';
  lbl_pressaovapor.Caption := '';
  lbl_res_pmv.Caption := '';
  lbl_umidade_result.Caption := '';
  lbl_res_orv_k.Caption := '273,10';
end;
